...
$to = "ventas@ledar.com.ar"; // Nuestro correo de contacto
...
if(isset($response) && $response["success"] === true) {
    ...
    // B - CAPTCHA WRONG, posible BOT >> NO HACEMOS NADA Y NO ENVIAMOS MAIL
     echo '<div class="alert alert-danger" style="margin-top:10px;"><strong>Atención!</strong> Tilda el casillero "No soy un robot." y completa todos los campos</div>';
}
